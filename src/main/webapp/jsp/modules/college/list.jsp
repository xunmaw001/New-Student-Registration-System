                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <%--<label>--%>
                                            <%--字段名  Search--%>
                                            <%--<input type="text" id="dicNameSearch" class="form-control form-control-sm"--%>
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('codeIndex')">学院编码</th>
                                    <th onclick="sort('indexName')">学院名</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
...
<script>
    ...
    function search() {
        ...
        if ($('#dicNameSearch').val() != null && $('dicNameSearch').val() != '') {
            searchForm.dicName = $('#dicNameSearch').val();
...
/*
    ...
    //添加
    function add() {
        window.sessionStorage.setItem('adddictionay', "adddictionay")
        window.location.href = "add-or-update.jsp"
    }
