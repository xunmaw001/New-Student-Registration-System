...
<script>
    ...
    // 获取当前详情
    function getDetails() {
        var adddictionay = window.sessionStorage.getItem("adddictionay");
        if (adddictionay != null && adddictionay != "" && adddictionay != "null") {
            window.sessionStorage.removeItem('adddictionay');
