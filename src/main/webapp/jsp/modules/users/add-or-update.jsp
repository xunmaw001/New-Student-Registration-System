...
<body>
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" v-model="ruleForm.id" type="hidden">
										...
										<div class="form-group col-md-6">
											<label>角色</label>																								
											<input class="form-control"  name="role" id="role" v-model="ruleForm.role" class="form-control" >
										</div>
	...
	<script>
        ...
        function readonly() {
            if (window.sessionStorage.getItem('role') != '学院管理员') {
